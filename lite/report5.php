...
<body>
 ...
 <br>
 <div align="center">
 <img src="images\report2.jpg" width="500px"></img>
  </div>
 ...
 <div class="col-md-12" align="center">
  ...
  error_reporting(~E_NOTICE);
    ...
    $conn->query("SET NAMES UTF8");	  
      $sql ="SELECT graduation_projects.advisor, COUNT(graduation_projects.gp_id) As SSport FROM graduation_projects where issued_date >='$rs' 
             
            GROUP BY graduation_projects.advisor ORDER BY SSport ";
      $result = mysqli_query($conn, $sql);
      while($row = mysqli_fetch_array($result)){

      	array_push($SE_Namex,$row['advisor']);
  ...
  <script>
    ...
    $(function () {
      $('#container').highcharts({
          ...
          title: {
                text: 'รายงานจำนวนโครงงานในที่ปรึกษา' 
          },
          subtitle: {
                text: ''
          },
