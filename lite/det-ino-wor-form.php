...
<div id="page">
    ...
    <?php   
		$sql = "SELECT * FROM innovative_works";
    ...
    if(isset($_POST['submitBtn'])){
      $sql = "SELECT * FROM innovative_works WHERE owner LIKE '%" . $_POST['owner'] . "%'";
    }
    $result = mysqli_query($conn, $sql);
    if (mysqli_num_rows($result) != 0) {
      while($row = mysqli_fetch_array($result)) {
        $output .= " <br/>	
				...
				<p style=\"font-size:18px; text-align: center; vertical-align:middle; \"> หัวข้อผลงาน  " . $row['title'] . " ผลงานประเภท" . $row['subject'] . "</p>
