<?php
    ...
    $sql = "INSERT INTO hall_of_frames_std (title,description,issued_date,branch,subject,type,file_directory,status)
    VALUES('" . $v_title ."','" . $v_des . "','" .$v_date . "','" . $v_branch . "','" .$v_subject . "','" . $v_type . "','" . $v_file_dire . "','" . $v_status . "')";
