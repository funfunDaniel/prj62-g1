    ...
    <div id="resume202">
        ...
        <div class="thumb-post1" id="picprofile">
            ...
            <!-- Education -->   
                ...
                <div style=" position: absolute;top: 400px; left: 500px;font-size: 19px;color:black;"><p id="university2"></p> </div>
                <div style=" position: absolute;top: 420px; left: 500px;font-size: 19px;color:black;"><p id="university3"></p></div>
                <div style=" position: absolute;top: 470px; left: 400px;font-size: 19px;color:black;"><p id="matthayom1"></p></div>
                <div style=" position: absolute;top: 470px; left: 500px;font-size:19px;color:black;"><p id="matthayom2"></p></div>
                <div style=" position: absolute;top: 490px; left: 500px;font-size:19px;color:black;"><p id="matthayom3"></p></div>
                <div style=" position: absolute;top: 540px; left: 400px;font-size: 19px;color:black;"><p id="prathom1"></p></div>
                <div style=" position: absolute;top: 540px; left: 500px;font-size:19px;color:black;"><p id="prathom2"></p></div>
                <div style=" position: absolute;top: 560px; left: 500px;font-size:19px;color:black;"><p id="prathom3"></p></div>
            ...
            <!-- References -->
                ...
                <div style=" position: absolute;top: 1200px; left: 400px;font-size: 19px;color:black;">Address : <p id="refadd2"></p></div>
