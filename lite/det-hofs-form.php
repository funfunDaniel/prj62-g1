...
<div id="page">
    ...
    <?php   
		$sql = "SELECT * FROM hall_of_frames_std";
    ...
    if(isset($_POST['submitBtn'])){
      $sql = "SELECT * FROM hall_of_frames_std WHERE subject LIKE '%" . $_POST['subject'] . "%'";
    }
    $result = mysqli_query($conn, $sql);
    if (mysqli_num_rows($result) != 0) {
      while($row = mysqli_fetch_array($result)) {
        $output .= " <br/>	
				...
				<p style=\"font-size:16px; text-align: center; vertical-align:middle; \"> ได้รับรางวัล" . $row['title'] . "</p>
				<p style=\"font-size:18px; text-align: center; vertical-align:middle; \"> ในสาขาวิชา  " . $row['branch'] . " รางวัลประเภท" . $row['type'] . "</p><br/><br/><br/>
				<p style=\"font-size:18px; text-align: center; vertical-align:middle; \">" . $row['description'] . "</p>	<br/><br/>	
						" ;
      }
    } else {
		$output = "";
