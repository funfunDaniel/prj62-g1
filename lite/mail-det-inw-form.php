...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <datalist id="owner"> 	
			<?php   
				...
				$sql = "SELECT * FROM innovative_works WHERE owner ='$owner' and inw_id ='$id'";
			...
			<?php
				...
				$sql = "SELECT * FROM innovative_works WHERE owner ='$owner' and inw_id ='$id' ";
					...
					$output .= " <br/>	
									...
									<p style=\"font-size:18px; text-align: center; vertical-align:middle; \"> หัวข้อผลงาน  " . $row['title'] . " ประเภท" . $row['subject'] . "</p>
