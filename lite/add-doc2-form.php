<div class="add-data-form">
    <div class="card card-top" style="width: 900px; ">
        <h3>แบบฟอร์มหนังสือขอเก็บข้อมูล</h3>
        <hr/>
        <form class="add-form" action="insert-doc2.php" method="POST" enctype="multipart/form-data" onsubmit="return confirm('คุณต้องการบันทึกข้อมูลหรือไม่ ?')">
