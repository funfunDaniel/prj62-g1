...
<p  id="preview"><img src="../images/resume-templete/resume-pink.png" style="height:1350px;width:1020px;"></p>
    <!-- resume2 -->
    <div id="resume202">
        <div>
        ...
        <div class="thumb-post1" id="picprofile">
            ...
            <!-- skills (ดึงจากฐานข้อมูล) -->
                ...
                <div style=" position: absolute;top:1100px; left: 700px;font-size: 19px;color:black;"  id="qrcode">
