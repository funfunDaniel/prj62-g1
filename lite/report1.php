...
<body>
 ...
 <br>
 <div align="center">
 <img src="images\report1.jpg" width="500px"></img>
  </div>
 ...
 <div class="col-md-12" align="center">
  ...
  error_reporting(~E_NOTICE);
    ...
    $conn->query("SET NAMES UTF8");	  
      $sql ="SELECT hall_of_frames_std.type, COUNT(hall_of_frames_std.hofs_id) As SSport FROM hall_of_frames_std where issued_date >='$rs' and status !='$s' and status !='$sr' 
             
            GROUP BY hall_of_frames_std.type ORDER BY SSport ";
      $result = mysqli_query($conn, $sql);
      while($row = mysqli_fetch_array($result)){

      	array_push($SE_Namex,$row['type']);
