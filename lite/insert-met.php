<?php
    ...
    $v_type = $_POST["type"];
	$v_file_dire = "";
	$v_col_type = "รายงานการประชุมของสาขาวิชา";
	$v_date = date("Y-m-d");
    ...
    $sql = "INSERT INTO met (title,description,issued_date,type,subject,file_directory)
    VALUES('" . $v_title ."','" . $v_des . "','" .$v_date . "','" . $v_type . "','" .$v_subject . "','" . $v_file_dire . "')";
        
    if (mysqli_multi_query($conn, $sql)) {
        $sql = "SELECT * FROM met ORDER BY met_id DESC LIMIT 1";
