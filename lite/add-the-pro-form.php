<div class="add-data-form">
    <div class="card card-top" style="width: 900px; ">
        <h3>โครงร่างวิทยานิพนธ์</h3>
        <hr/>
        <form class="add-form" action="insert-the-pro.php" method="POST" enctype="multipart/form-data" onsubmit="return confirm('คุณต้องการบันทึกข้อมูลหรือไม่ ?')">
            ...
            <textarea rows="4" cols="40" name="des" required autofocuss></textarea>
            <br>
            <br>

            <label for="p">สำนักพิมพ์</label>
