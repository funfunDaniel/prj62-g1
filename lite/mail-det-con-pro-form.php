...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <datalist id="owner"> 	
			<?php   
				...
				$sql = "SELECT * FROM course_projects WHERE owner ='$owner' and cp_id ='$id'";
			...
			<?php
				...
				$sql = "SELECT * FROM course_projects WHERE owner ='$owner' and cp_id ='$id' ";
					...
					$output .= " <br/>	
									...
									<p style=\"font-size:18px; text-align: center; vertical-align:middle; \"> หัวข้อรางวัล  " . $row['title'] . " ในรายวิชา " . $row['course'] . "</p><br/><br/><br/>
