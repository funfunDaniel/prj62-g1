        ...
        if(isset($_REQUEST["view"])){
               ...
               <div class="comment-widgets">
                  ...
                  <div class="comment-text ">
                   <h5>สาขาเทคโนโลยีสารสนเทศ</h5>
                    <p> ยินดีต้อนรับเข้าสู่เว็บไซด์ของสำนักวิชาเทคโนโลยีสังคม สาขาเทคโนโลยีสารสนเทศ มหาวิทยาลัยเทคโนโลยีสุรานารี
                         ...
                         หากผู้ใช้ต้องการดูข้อมูลกิจกรรม ข้อมูลผลงาน อัปเดทผลการเรียน และดูคำร้องขอใบสัมฤทธิบัตร กรุณาเลือกเมนูที่ต้องการ
                          </p> 
                  </div>
                ...
                <div class="d-flex flex-row comment-row ">
                  ...
                  <div class="comment-text">
                    <h5>เมนู</h5>
                    <li><a href="Request-data-Student.php" > กิจกรรม </a></li>
                    <li><a href="index-it.php?view=ww" > ผลงาน </a></li>
                    <li><a href="profile-data-form.php" > ผลการเรียน </a></li>
                    <li><a href="index-it.php?view=wwww" > คำร้องขอใบสัมฤทธิบัตร </a></li>
                  </li>
                  </div>
