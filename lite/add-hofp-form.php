<div class="add-data-form">
    <div class="card card-top" style="width: 900px; ">
        <h3>รางวัลเกียรติยศอาจารย์</h3>
        <hr/>
        <form class="add-form" action="insert-hofp.php" method="POST" enctype="multipart/form-data" onsubmit="return confirm('คุณต้องการบันทึกข้อมูลหรือไม่ ?')">
            ...
            <label for="resource">หัวเรื่อง</label>
