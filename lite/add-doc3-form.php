<div class="add-data-form">
    <div class="card card-top" style="width: 900px; ">
        <h3>แบบฟอร์มหนังสือแต่งตั้งผู้เชี่ยวชาญ</h3>
        <hr/>
        <form class="add-form" action="insert-doc3.php" method="POST" enctype="multipart/form-data" onsubmit="return confirm('คุณต้องการบันทึกข้อมูลหรือไม่ ?')">
