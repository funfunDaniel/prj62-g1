<div class="add-data-form">
    <div class="card card-top" style="width: 900px; ">
        <h3>วิทยานิพนธ์</h3>
        <hr/>
        <form class="add-form" action="insert-the.php" method="POST" enctype="multipart/form-data" onsubmit="return confirm('คุณต้องการบันทึกข้อมูลหรือไม่ ?')">
            ...
            <label for="degreename">ชื่อปริญญา</label>
            <input type="text" name="degreename">
            <br>
            <br>

            <label for="degreelevel">ระดับปริญญา</label>
            <input type="text" name="degreelevel">
            <br>
            <br>

            <label for="degreedescripline">สาขาวิชา</label>
            <input type="text" name="degreedescripline">
            <br>
            <br>
