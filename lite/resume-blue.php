...
<head>
        ...
        <style>
                ...
                .bg{height:80em;}
                .fullname{color:white; position: absolute;top: 1.2em; left: 1.5em;  font-size: 44px;}
                ...
                .skill{position: absolute;top: 39em; left: 35em;width:auto;font-size: 18px;}
...
<body>
<p  id="preview"><img src="../images/resume-templete/resume-blue.png" class="bg"></p>
    <!-- resume2 -->
    <div id="resume202">
        <div>
