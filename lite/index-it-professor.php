    ...
    <div class="page-wrapper">
      <div class="card-block">
        ...
        if(isset($_REQUEST["view"])){
                ...
                <div class="card-body">
                  <h4 class="card-title text-center">ยินดีต้อนรับเข้าสู่ สาขาเทคโนโลยีสารสนเทศ</h4>
               </div>
               ...
               <div class="comment-widgets">
                ...
                <div class="d-flex flex-row comment-row">
                  ...
                  <div class="comment-text ">
                   <h5>สาขาเทคโนโลยีสารสนเทศ</h5>
                    <p> ยินดีต้อนรับเข้าสู่เว็บไซด์ของสำนักวิชาเทคโนโลยีสังคม สาขาเทคโนโลยีสารสนเทศ มหาวิทยาลัยเทคโนโลยีสุรานารี
                    </br>
                         หากผู้ใช้ต้องการดูคำร้องขอต่าง ๆ กรุณาเลือกเมนูที่ต้องการ
                          </p> 
                  </div>
                ...
                <div class="d-flex flex-row comment-row ">
                  ...
                  <div class="comment-text">
                    <h5>เมนู</h5>
                    <li><a href="prof-add-activity-form.php" class=\"w3-bar-item w3-button\"><font style=\"font-size:14px\">เพิ่มกิจกรรม</font></a>
                    <li><a href=\"#\" class=\"w3-bar-item w3-button\"><font style=\"font-size:14px\">คำร้องขอ</font></a>
                    <ul>
                      <li><a href="prof-Request-activity.php" >คำร้องขอเข้าร่วมกิจกรรม </a></li>
                      <li><a href="index-it.php?view=ww" > คำร้องขอเพิ่มผลงาน </a></li>
                      <li><a href="profile-data-form.php" > คำร้องขอประวัติข้อมูลผลงาน </a></li>
                    </ul>                 
                    <li><a href=\"#\" >ผลการเรียนของนักศึกษา </a></li>
                    <li><a href=\"#\" >.ใบสัมฤทธิบัตรของนักศึกษา </a></li>
