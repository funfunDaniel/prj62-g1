...
<br>
 <div align="center">
 <img src="images\report3.jpg" width="500px"></img>
  </div>
<br><br>
 ...
 <div class="col-md-12" align="center">
  ...
  $conn = mysqli_connect($db_hostname, $db_username, $db_password, $db_name);
    ...
    $conn->query("SET NAMES UTF8");	  
       $sql ="SELECT request.res_type, COUNT(request.cidd) As SSport FROM request where issued_date >='$rs' 
             
            GROUP BY request.res_type ORDER BY SSport ";
      $result = mysqli_query($conn, $sql);
      while($row = mysqli_fetch_array($result)){

      	array_push($SE_Namex,$row['res_type']);
